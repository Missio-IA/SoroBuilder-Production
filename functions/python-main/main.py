...
client = OpenAI(api_key="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")
...
pusher_client = pusher.Pusher(
  app_id='1878875',
  key='e695aba01bee94c8cfcc',
  secret='c5a3c120b8cff9a3b51d',
  cluster='eu',
  ssl=True
)
...
def chat_handler(req: https_fn.Request) -> https_fn.Response:
    ...
    try:
        ...
        #https://forms.gle/ZX6bGYcS2hxPaw5Z6
        ...
        with client.beta.threads.runs.stream(
            thread_id=thread_id,
            assistant_id='asst_DpnXsjjMySLkyFVmgCBwOZJn',
        ...
        if event_handler.generate_contract_called:
            ...
            generate_contract(thread_id, channel_id, user_input, user_id)
...
def generate_contract(thread_id, channel_id, user_input, user_id):
    ...
    try:
        ...
        try:
            with client.beta.threads.runs.stream(
                ...
                assistant_id='asst_oo5COUzDAE8S6rNGsU3lMOTc',
                event_handler=event_handler
            ) as stream:
                stream.until_done()
            ...
            if designer_output.strip():
                ...
                contract_id = save_contract_data(project_name, generated_files, user_input, user_id)
...
def build_file(building_thread_id, channel_id, file_path):
    ...
    if file_path.endswith('_test.rs'):
        assistant_id = 'asst_DEpqSbQ8SAStjsCHjQ19j2g9'
        ...
        assistant_id = 'asst_wMqGUOFKHVkV3NkJzA9RTvfp'
        ...
        assistant_id = 'asst_lAzingm33b8DBjre3LZwLqmj'
...
def save_contract_data(project_name, files_data, user_input, user_id):
    """
